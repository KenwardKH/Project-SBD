                    ...
                    <td>
                        <div class="button-group" style="display: flex; justify-content:space-around">
                            ...
                            <form action="{{ route('delete-post', ['id' => $post->id]) }}" method="GET">
                                ...
                                <button class="delete" type="submit" onclick="return confirm('Apakah anda yakin untuk menghapus postingan ini?')">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                        <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5M11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47M8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5"/>
                                    </svg>
                                </button>
                            </form>
                            <button class="comments" data-toggle="modal" data-target="#comments{{ $post->id }}">
                        ...
                        <!-- Modal for comments -->
                        <div class="modal fade" id="comments{{ $post->id }}" tabindex="-1" role="dialog" aria-labelledby="commentsLabel{{ $post->id }}" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="commentsLabel{{ $post->id }}">Comments</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body" style="text-align: left;">
                                        ...
                                        @else
                                            @foreach($post->comments as $comment)
                                                @if(!$comment->reply_to)
                                                    <div class="comment" style="margin-bottom: 10px;margin-top: 50px">
                                                        <strong>{{ $comment->author }}</strong><br>
                                                        <span style="color: rgb(127, 140, 255)">{{ $comment->date }}</span><br>
                                                        <p style="margin: 0;">{{ $comment->content }}</p>
                                                    </div>
                                                    @foreach($comment->replies as $reply)
                                                        <div class="comment" style="margin-left: 30px; margin-bottom: 10px;">
